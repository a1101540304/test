...
<div id="a"><a class="button green">首页</a><a href="merchinfo.jsp" class="button green">购买商品</a><a href="user.jsp" class="button green">修改密码</a><a class="button green">合作</a></div>
  <p class="ys2">
  <hr width="98%" />
  <p class="ys2">  
